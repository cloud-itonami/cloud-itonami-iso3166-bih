(ns marketentry.store
  "SSoT for the Bosnia and Herzegovina (BIH) market-entry compliance
...
(defn demo-data
  ...
  `:annual-turnover` / `:tax-arrears-amount` are KM (convertible mark),
  last finished financial year -- ground truth for the
  `tax-social-security-arrears-violation?` flagship check (ZJN Čl.
  45(1)(c)-(d), NO de-minimis carve-out). `:requires-jib?`/
  `:jib-verified?` stand in for the Entity-level 13-digit JIB tax
  identifier a business must hold and have verified before its
  STATE-level UIO indirect-tax identification number (derived from that
  JIB, see `marketentry.facts`) can be relied on for e-Nabavke portal
  participation."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Fabrikacija d.o.o." :portal "e-Nabavke"
             ...
             :requires-jib? true :jib-verified? true
             :drafted? false :submitted? false
             :jurisdiction "BIH" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-Nabavke"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :annual-turnover 2000000 :tax-arrears-amount 0
             :tax-arrears-reprogrammed-confirmed? false
    ...
    "eng-3" {:id "eng-3" :operator "Minami Sistemi d.o.o." :portal "e-Nabavke"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "BIH" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Izvoz d.o.o." :portal "e-Nabavke"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "BIH" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistika d.o.o." :portal "e-Nabavke"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :annual-turnover 2000000 :tax-arrears-amount 0
             :tax-arrears-reprogrammed-confirmed? false
             :requires-jib? true :jib-verified? false
             :drafted? false :submitted? false
             :jurisdiction "BIH" :status :intake}
    "eng-6" {:id "eng-6" :operator "Sredina Civic Tech d.o.o." :portal "e-Nabavke"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               annual-turnover tax-arrears-amount tax-arrears-reprogrammed-confirmed?
                               requires-jib? jib-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    annual-turnover                       (assoc :engagement/annual-turnover annual-turnover)
    (some? tax-arrears-amount)            (assoc :engagement/tax-arrears-amount tax-arrears-amount)
    (some? tax-arrears-reprogrammed-confirmed?) (assoc :engagement/tax-arrears-reprogrammed-confirmed? tax-arrears-reprogrammed-confirmed?)
    (some? requires-jib?)                 (assoc :engagement/requires-jib? requires-jib?)
    (some? jib-verified?)                 (assoc :engagement/jib-verified? jib-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/annual-turnover :engagement/tax-arrears-amount :engagement/tax-arrears-reprogrammed-confirmed?
   :engagement/requires-jib? :engagement/jib-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :annual-turnover (:engagement/annual-turnover m)
     :tax-arrears-amount (:engagement/tax-arrears-amount m 0)
     :tax-arrears-reprogrammed-confirmed? (boolean (:engagement/tax-arrears-reprogrammed-confirmed? m))
     :requires-jib? (boolean (:engagement/requires-jib? m))
     :jib-verified? (boolean (:engagement/jib-verified? m))
